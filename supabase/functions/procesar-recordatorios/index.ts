...
serve(async (req) => {
  ...
  // AUTZ server-to-server: secreto compartido (NO JWT de usuario), mismo molde que enviar-push-notificacion.
  // La dispara un cron/scheduler, no un usuario. Sin CRON_SECRET configurado → 401 (safe-default).
