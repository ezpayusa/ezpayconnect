        ...
        <Card className="w-full max-w-md shadow-xl">
          <CardContent className="p-8 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Tu cuenta de {etiquetaRol(invitacion?.rol)} ha sido creada. Ya puedes iniciar sesión.
            </p>
      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Has sido invitado como <strong>{etiquetaRol(invitacion?.rol)}</strong> en <strong>{invitacion?.empresa_nombre}</strong>
          </p>
        </CardHeader>
        <CardContent>
