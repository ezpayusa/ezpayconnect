...
import { ArrowLeft, Plus, Search, RefreshCw, Edit, Trash2, FlaskConical } from 'lucide-react';
...
export default function PlanesLabConfigPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <Card>
          <CardContent className="pt-4">
            ...
            <p className="text-2xl font-bold">{planesLab.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4">
            <p className="text-sm text-muted-foreground">Configuraciones</p>
            <p className="text-2xl font-bold">{configsLab.length}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4">
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <p className="text-2xl font-bold">{planesLab.length > 0 ? Math.max(...planesLab.map(p => p.precio_base)) : 0} USD</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-lg">Planes Base Laboratorio</CardTitle>
        </CardHeader>
        <CardContent>
                ...
                {planesFiltrados.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                      No se encontraron planes laboratorio
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
            ...
            <Table>
              ...
              <TableBody>
                ...
                {configsLab.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                      No hay configuraciones de laboratorio
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
