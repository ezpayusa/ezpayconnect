  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card><CardContent className="pt-4"><p className="text-sm text-muted-foreground">Activas</p><p className="text-2xl font-bold text-green-600">{stats.activos}</p></CardContent></Card>
        <Card><CardContent className="pt-4"><p className="text-sm text-muted-foreground">Por vencer</p><p className="text-2xl font-bold text-red-600">{stats.porVencer}</p></CardContent></Card>
      </div>
