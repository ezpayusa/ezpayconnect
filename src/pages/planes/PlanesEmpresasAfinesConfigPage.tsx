...
import { ArrowLeft, Plus, Search, RefreshCw, Edit, Trash2, Handshake, Save, X, AlertTriangle } from 'lucide-react';
          ...
          {dialogoEditar && (
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleEditarPlan} className="bg-[#4f46e5] hover:bg-[#4f46e5]/90">
