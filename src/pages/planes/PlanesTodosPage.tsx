...
import { Stethoscope, MapPin, FlaskConical, Truck, Check, ArrowRight, CreditCard } from 'lucide-react';
...
const categorias = [
  ...
  { id: 'clinica', label: 'Clínica', icon: MapPin, color: 'blue', path: '/planes-clinica' },
