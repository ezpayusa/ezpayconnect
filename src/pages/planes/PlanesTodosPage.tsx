...
import { Stethoscope, Home, FlaskConical, Truck, Check, ArrowRight, CreditCard } from 'lucide-react';
...
const categorias = [
  ...
  { id: 'clinica', label: 'Clínica', icon: Home, color: 'blue', path: '/planes-clinica' },
