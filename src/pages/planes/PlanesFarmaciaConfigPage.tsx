...
import { ArrowLeft, Plus, Search, RefreshCw, Edit, Trash2, Store } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">Configuración Planes Farmacia</h1>
            <p className="text-sm text-muted-foreground">Gestiona planes para farmacias y droguerías</p>
          </div>
        </div>
