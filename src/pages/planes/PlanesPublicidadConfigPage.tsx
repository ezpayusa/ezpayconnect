...
import { ArrowLeft, Plus, Search, RefreshCw, Edit, Trash2, Megaphone, Save, X, AlertTriangle } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <Dialog open={!!dialogoEditar} onOpenChange={() => setDialogoEditar(null)}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <Edit className="h-5 w-5 text-[#d97706]" />
              Editar Plan Publicidad
            </DialogTitle>
          </DialogHeader>
          {dialogoEditar && (
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleEditarPlan} className="bg-[#d97706] hover:bg-[#d97706]/90">
