...
const ComercialHoyPage = lazy(() => import('@/comercial/pages/HoyPage'))
const ComercialVisitaPage = lazy(() => import('@/comercial/pages/VisitaFichaPage'))
const ComercialEquipoPage = lazy(() => import('@/comercial/pages/EquipoPage'))
...
const ComercialMiTarjetaPage = lazy(() => import('@/comercial/pages/MiTarjetaPage'))
...
const MedicoPerfilPage = lazy(() => import('@/medico/pages/MedicoPerfilPage'))
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/comercial" element={<ComercialPrivateRoute><ComercialLayout /></ComercialPrivateRoute>}>
          ...
          <Route path="hoy" element={<ComercialHoyPage />} />
          <Route path="visitas/:id" element={<ComercialVisitaPage />} />
          <Route path="equipo" element={<ComercialEquipoPage />} />
          <Route path="equipo/:asesorId" element={<ComercialEquipoAsesorPage />} />
          <Route path="material" element={<ComercialMaterialPage />} />
          <Route path="mi-tarjeta" element={<ComercialMiTarjetaPage />} />
        </Route>
        ...
        <Route path="/medico" element={<MedicoPrivateRoute><MedicoLayout /></MedicoPrivateRoute>}>
          ...
          <Route path="perfil" element={<MedicoPerfilPage />} />
