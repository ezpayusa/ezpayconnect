...
import { useAdmisionCitas, CitaAdmision } from '@/clinica/hooks/useAdmisionCitas'
import { FormularioVitales, VitalesValues, VITALES_VACIO } from '@/clinica/components/FormularioVitales'
