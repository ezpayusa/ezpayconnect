// ═══════════════════════════════════════════════════════════════
// EZPAYCONNECT - UTILIDADES DE PLANES (ADAPTADO)
// ═══════════════════════════════════════════════════════════════

import { PlanConfiguracion, PlanFeature, PaisCodigo } from '@/types/planes';
...
export function getNombrePais(codigo: PaisCodigo): string {
  const nombres: Record<PaisCodigo, string> = { GT: 'Guatemala', SV: 'El Salvador', HN: 'Honduras' };
  return nombres[codigo] || codigo;
}

export function getBanderaPais(codigo: PaisCodigo): string {
  const banderas: Record<PaisCodigo, string> = { GT: '🇬🇹', SV: '🇸🇻', HN: '🇭🇳' };
