...
// una farmacia-CATÁLOGO existente a tenant es un flujo aparte (super_admin, Inc.1).
export default function FarmaciaRegistro() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Registro de Farmacia</CardTitle>
          <p className="text-sm text-muted-foreground">{step === 1 ? 'Datos de la farmacia' : 'Datos del representante'}</p>
        </CardHeader>
        <CardContent>
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input value={form.nombre_empresa} onChange={(e) => update('nombre_empresa', e.target.value)} placeholder="Ej: Farmacia San José" required />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input type="email" value={form.email_contacto} onChange={(e) => update('email_contacto', e.target.value)} placeholder="contacto@farmacia.com" required />
                  </div>
                  <div className="space-y-2">
                ...
                <Button type="submit" className="w-full bg-[#B45309] hover:bg-[#92400e]">Continuar</Button>
              </>
            ) : (
              <>
                <div className="space-y-2">
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/farmacia/login" className="text-[#B45309] hover:underline font-medium">Inicia sesión</Link>
          </div>
