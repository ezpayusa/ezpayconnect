...
- **Próximos números libres: probe `P906`** (global, no por módulo; P906-P907 reservados para la mig 336 — el primero libre fuera de la reserva es `P912`), **migración `336`**, **errcode `PA035`** (comercial),
