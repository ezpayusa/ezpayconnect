...
- **Próximos números libres: probe `P861`** (global, no por módulo), **migración `331`**, **errcode `PA035`** (comercial),
  ...
  **`SV003`** (signos vitales: SV001 = fuera de rango, SV002 = formato de PA, mig 330
