...
- **Residual menor aparte (no R11):** `anon` tiene grants de tabla INSERT/UPDATE/DELETE sobre `farmacia_medicamentos`, **inertes** bajo RLS (todas las policies son `TO authenticated`); REVOKE defensa-en-profundidad en evaluación.
