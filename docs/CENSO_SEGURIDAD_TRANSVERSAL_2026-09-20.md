...
| 225 SECDEF clasificadas "gate + pertenencia" | **No se releyeron una por una.** El clasificador confirma que llaman a un helper de identidad; la corrección de cada gate contra el trivaluado la cubrió `docs/CENSO_FAILOPEN_2026-09-18.md` (25 candidatas, 3 confirmadas y cerradas en la 300). La pertenencia fina (que el id recibido sea del tenant correcto) queda fuera de este censo. | — | — | (no medido) |
